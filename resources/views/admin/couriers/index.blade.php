...
<h2>Курьеры</h2>
<a class="bttn blue" href="{{ route('couriers.create') }}">
...
<table class="table table-striped table-hover">
    ...
    @foreach($couriers as $el)
        <tr>
            ...
            <td>{{ $el->email }}</td>
            <td>
                <a class="bttn blue" href="{{ route ( 'couriers.edit', $el->id) }}">
                ...
                <form class="d-inline" action="{{ route ('couriers.destroy', $el->id) }}" method="post">
                    @csrf
                    @method('DELETE')
