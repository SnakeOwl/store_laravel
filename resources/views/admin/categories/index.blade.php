...
<a class="bttn blue" href="{{ route('categories.create') }}">
...
<table class="table table-striped table-hover">
    <thead>
        ...
        <th>Название</th>
        <th>Алиас</th>
        <th class="d-none">Родитель (id)</th>
    </thead>
    <tbody>
    ...
    @foreach($categories as $category)
        <tr>
            ...
            <td class="d-none">{{ $category->id_parent }}</td>

            <td>
                <a class="bttn blue" href="{{route( 'categories.edit', $category->id)}}">
