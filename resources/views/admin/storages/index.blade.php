...
<a class="bttn blue" href="{{ route('storages.create') }}">
...
<table class="table table-striped table-hover mt-2">
    ...
    @foreach($storages as $el)
        <tr>
            ...
            <td>
                <a class="bttn blue" href="{{ route ( 'storages.edit', $el->id) }}">
                ...
                <form class="d-inline" action="{{ route ('storages.destroy', $el->id) }}" method="post">
                    @csrf
                    @method('DELETE')
                    <button class="bttn red" type="submit">
